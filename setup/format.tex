...
\titlespacing{\chapter}{0pt}{4pt}{14pt}  % 前面空一行实在太多了，行距问题
...
\def\cdegreethesis#1{\def\@cdegreethesis{#1}}\def\@cdegreethesis{}
...
%\cleardoublepage%
  ...
  \setlength{\@title@width}{3.5cm}
  {
    ...
    \begin{tabular}{lcclc}
    \xiaosi\hei{学校代号}&  \underline{\makebox[\@title@width][c]{\textsf{\xiaosi\hei\@chnunumer}}}&\qquad \qquad \qquad \qquad \qquad & \xiaosi\hei{学\qquad 号}&  \underline{\makebox[\@title@width][c]{\textsf{\xiaosi\hei\@cnumber}}}\\ 
    \xiaosi\hei{分~~类~~号}&  \underline{\makebox[\@title@width][c]{\textsf{\xiaosi\hei\@cclassnumber}}}&\qquad \qquad \qquad \qquad \qquad & \xiaosi\hei{密\qquad 级}&  \underline{\makebox[\@title@width][c]{\xiaosi\hei\@csecret}} \\
     & & & & \\ % 用于空行
    %  & & & & \\
    \end{tabular}
  }
  ...
  \begin{spacing}{2.1}
	...
	\makebox[3.3cm][s]{\xiaosi\hei{专~业~学~位~类~别}} \xiaosi\song\underline{\makebox[\@title@width][c]{\@cmajor}} \\
	\makebox[3.3cm][s]{\xiaosi\hei{专~业~学~位~领~域}} \xiaosi\song\underline{\makebox[\@title@width][c]{\@csubject}} \\
	% \makebox[3.3cm][s]{\xiaosi\hei{导师姓名及职称}} \xiaosi\song\underline{\makebox[\@title@width][c]{\@csupervisor}} \\
	\makebox[3.3cm][s]{\scalebox{0.86}[1]{\xiaosi\hei{校内导师姓名及职称}}} \xiaosi\song\underline{\makebox[\@title@width][c]{\@csupervisor}} \\
	\makebox[3.3cm][s]{\scalebox{0.86}[1]{\xiaosi\hei{校外导师姓名及职称}}} \xiaosi\song\underline{\makebox[\@title@width][c]{\@ocsupervisor}} \\
...
\renewcommand{\arraystretch}{1.5}  % 行间距
\begin{tabular}{ll}
\makebox[2cm][s]{\xiaosi\hei 学校代号:}\textsf{\xiaosi\hei~~\@chnunumer} \\
\makebox[2cm][s]{\xiaosi\hei 学\qquad~号:}\textsf{\xiaosi\hei~~\@cnumber} \\
...
\begin{center}
  ...
  {\xiaoer\song\bf \@chnuname \@cdegreethesis}  % bf加粗
  \vspace*{1cm}
...
% \setcounter{page}{1}
\qquad\\
\begin{center}{\hei\xiaosi \textbf{\@untitle}}\end{center}\par
\begin{center}{\hei\xiaosi \textbf{\@declaretitle}}\end{center}\par
...
\vspace{2\baselineskip}
\begin{center}{\hei\xiaosi \textbf{\@authorizationtitle}}\end{center}\par
{
